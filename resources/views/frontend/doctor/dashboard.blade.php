                                            ...
                                            <div class="dash-widget dct-border-rht">
                                                <div class="circle-bar circle-bar1">
                                                    <div class="circle-graph1" data-percent="100">
                                                        <img src="{{asset('assets/frontend/img/icon-01.png')}}"
                                            ...
                                            <div class="dash-widget dct-border-rht">
                                                <div class="circle-bar circle-bar2">
                                                    <div class="circle-graph2" data-percent="65">
                                                        <img src="{{asset('assets/frontend//img/icon-02.png')}}"
                                                             class="img-fluid" alt="Patient">
                                                    </div>
                                                </div>
                                                <div class="dash-widget-info">
                                                    <h6>Bugünki Hastalar</h6>
                                                    <h3>160</h3>
                                            ...
                                            <div class="dash-widget">
                                                <div class="circle-bar circle-bar3">
                                                    <div class="circle-graph3" data-percent="50">
                                                        <img src="{{asset('assets/frontend/img/icon-03.png')}}"
                                                             class="img-fluid" alt="Patient">
                                                    </div>
                                                </div>
                                                <div class="dash-widget-info">
...
{{--                                                    <p class="text-muted">06, Apr 2019</p>--}}
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <h4 class="mb-4">Randevu İstekleri</h4>
