...
<img src="{{asset('assets/backend/assets/img/icon/calendar.png')}}" alt="User Image">
</span>
                        <div class="dash-count">
...
<img src="{{asset('assets/backend/img/icon/chart.png')}}" alt="User Image">
</span>
                        <div class="dash-count">
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="section-heading">
                <h5 class="mb-0">Bugünkü Randevular <span class="num-circle">12</span></h5>
            </div>
        </div>
                    ...
                    <div class="appointment-item">
                        ...
                        <div class="app-user">
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="app-img">
                                        <img src="{{asset('assets/backend/img/profiles/avatar-02.jpg')}}" alt="" class="img-fluid">
                                        <div class="app-name">
                                            <h6>Dr. Lester </h6>
                                            <p>Orthopaedics</p>
                                        </div>
                                ...
                                <div class="col-sm-6">
                                    <div class="app-img justify-content-sm-end">
                                        <img src="{{asset('assets/backend/img/profiles/avatar-05.jpg')}}" alt="" class="img-fluid">
                                        <div class="app-name">
                                            <h6>Chris Harris</h6>
                                            <p>ID : 781212, M</p>
                                        </div>
                    ...
                    <div class="appointment-item">
                        ...
                        <div class="app-user">
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="app-img">
                                        <img src="{{asset('assets/backend/img/profiles/avatar-06.jpg')}}" alt="" class="img-fluid">
                                        <div class="app-name">
                                            <h6>Dr. Monroe</h6>
            ...
            <div class="card">
                <div class="card-header border-bottom-0">
                    <div class="row align-items-center">
                        <div class="col">
                            <h5 class="card-title">Son Randevular</h5>
                        </div>
        ...
        <div class="col-lg-4">
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        <div class="col">
                            <h5 class="card-title">Top 10 Doktorlar</h5>
                        </div>
                    </div>
                </div>
                <div class="card-body p-0">
                    <div class="table-responsive">
                        <table class="table doc-table">
                            ...
                            <tr>
                                <td>
                                    <h2 class="table-avatar">
                                        <a class="avatar-pos avatar-offline" href="profile.html"><img
                                                class="avatar avatar-img"
                            ...
                            <tr>
                                <td>
                                    <h2 class="table-avatar">
                                        <a class="empty-user" href="profile.html"><i class="feather-user"></i>
                                        </a>
                ...
                <div class="card-body">
                    <div class="country-item">
                        <div class="con-name">
                            ...
                            <div class="flag-name">
                                <p class="user-name"><span>United States</span> <span
                                        class="d-block text-muted">800 Patients</span></p>
                            </div>
                        </div>
                    ...
                    <div class="country-item">
                        <div class="con-name">
                            ...
                            <div class="flag-name">
                                <p class="user-name"><span>United Kingdom</span> <span
                                        class="d-block text-muted">450 Patients</span></p>
                            </div>
                        </div>
                        <div class="con-revenue">
                            <p class="text-muted">Revenue</p>
                    ...
                    <div class="country-item">
                        <div class="con-name">
                            ...
                            <div class="flag-name">
                                <p class="user-name"><span>UAE</span> <span class="d-block text-muted">300 Patients</span>
                                </p>
                            </div>
                        </div>
                        <div class="con-revenue">
                    ...
                    <div class="country-item">
                        <div class="con-name">
                            ...
                            <div class="flag-name">
                                <p class="user-name"><span>India</span> <span class="d-block text-muted">300 Patients</span>
                                </p>
                            </div>
                        </div>
                        <div class="con-revenue">
